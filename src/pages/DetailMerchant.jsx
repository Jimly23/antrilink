...
const DetailMerchant = () => {
  return (
    <div className='min-h-[100vh] bg-dominan relative'>
        ...
        {/* Merchant Main */}
        <div className="relative main bg-dominan min-h-[90vh] rounded-t-[25px] mt-[-20px] p-5 z-50">
            ...
            <div className="box-antri text-[14px] h-[150px] bg-bg rounded-lg font-medium grid grid-cols-2">
